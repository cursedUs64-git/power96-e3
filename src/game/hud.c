...
void render_hud_mario_lives(void) {
    print_text(29, 210, ","); // 'Mario Head' glyph
    print_text(45, 210, "*"); // 'X' glyph
    print_text_fmt_int(59, 210, "%d", gHudDisplay.lives);
}
/**
...
#endif
    print_text_fmt_int(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(101), 20, "%02d", timerMins);
    print_text_fmt_int(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(70), 20, "%02d", timerSecs);
    print_text_fmt_int(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(39), 20, "%d", timerFracSecs);
