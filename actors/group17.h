...
// scuttlebug
extern Gfx RCP_walker_F_walk0[];
extern Gfx RCP_walker_F_walk1[];
extern Gfx RCP_walker_F_walk2[];
extern Gfx RCP_walker_F_walk3[];
extern Gfx RCP_walker_F_walk4[];
extern Gfx RCP_walker_F_walk5[];
extern Gfx RCP_walker_F_walk6[];
extern Gfx RCP_walker_F_walk7[];
extern Gfx RCP_walker_F_walk8[];
extern Gfx RCP_walker_F_walk9[];
extern Gfx RCP_walker_F_walk10[];
extern Gfx RCP_walker_F_walk11[];
extern Gfx RCP_walker_F_walk12[];
extern Gfx RCP_walker_F_walk13[];
extern Gfx RCP_walker_F_walk14[];
extern Gfx RCP_walker_F_walk15[];
extern Hierarchy RCP_HmsEnemywalker_F_walk[];
extern AnimePtr walker_anime[];
extern AnimeRecord walker_F_walk_anm[];
extern const struct Animation *const walker_F_walk_prm[];
extern const struct Animation *const walker_F_walk_tbl[];
